...
@property (nonatomic, readonly) UIButton *containerView; // for masking and interaction
...
+ (UIColor *)calloutDefaultBackgroundColor;
+ (UIEdgeInsets)defaultContentInset;
+ (CGFloat)calloutDefaultCornerRadius;
+ (CGFloat)calloutDefaultArrowHeight;
@end
